...
#'
#' @examples
CurateData <- function(DataModel = list())
{
...
# CCPhos::Recode() uses a dictionary in the form of a named vector to perform recoding on a target vector
