...
CheckDataSetDS <- function(DataSetName.S,
...
TableCheckTemplate <- RequiredTableNames.S %>%
...
# Go through actually existing table in 'DataSet' and check for feature completeness as well as feature types, row counts and rates of non-missing values
